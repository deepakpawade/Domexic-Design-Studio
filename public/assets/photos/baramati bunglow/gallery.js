...
var c = document.querySelector('.sign-back');
var d = document.querySelector('.sign-forward');
a.addEventListener('click',imgBtnClkFoward);
b.addEventListener('click',imgBtnClkBack);
c.addEventListener('click',imgBtnClkBack);
d.addEventListener('click',imgBtnClkFoward);
